...
namespace RestApi.Basic.Client.Autorest
{
    ...
    public partial interface IMyAPI : System.IDisposable
    {
        ...
        /// </param>
        Task<HttpOperationResponse<MyComplexThing>> ApiTypesGetWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
