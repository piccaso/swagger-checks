...
namespace RestApi.Basic.Client.Autorest
{
    ...
    public partial class MyAPI : ServiceClient<MyAPI>, IMyAPI
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<MyComplexThing>> ApiTypesGetWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "ApiTypesGet", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/Types").ToString();
            ...
            if ((int)_statusCode != 200)
            {
                ...
                try
                {
                    ...
                    IList<RestErrorResponse> _errorBody =  SafeJsonConvert.DeserializeObject<IList<RestErrorResponse>>(_responseContent, DeserializationSettings);
                    if (_errorBody != null)
                    {
                        ex.Body = _errorBody;
                    }
            ...
            // Create Result
            var _result = new HttpOperationResponse<MyComplexThing>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<MyComplexThing>(_responseContent, DeserializationSettings);
                }
